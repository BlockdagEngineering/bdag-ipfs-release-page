...
for name in ("INSTALL", "DOWNLOADS", "DATASETS", "PUBLISHER", "MIGRATION", "MIGRATION-AGENTS"):
    text = (root / (name + ".md")).read_text()
    for linked in ("INSTALL", "DOWNLOADS", "DATASETS", "PUBLISHER", "MIGRATION", "MIGRATION-AGENTS"):
    ...
    output = ('<!doctype html>\n<html lang="en"><head><meta charset="utf-8">'
              ...
              '<a href="DATASETS.html">Datasets</a><a href="MIGRATION.html">Migration</a><a href="PUBLISHER.html">Publisher</a><a href="AGENTS.md">AI agents</a></div></nav></header>'
