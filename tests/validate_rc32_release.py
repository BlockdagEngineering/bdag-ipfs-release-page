#!/usr/bin/env python3
"""Validate the signed, fail-closed RC32 release-page candidate."""
...
RELEASE = ROOT / "releases" / "2.0.0-community-rescue-rc.32"
MANIFEST_PATH = RELEASE / "release-manifest.json"
SOFTWARE = RELEASE / "records" / "software"
DATASET = RELEASE / "records" / "dataset"

VERSION = "2.0.0-community-rescue-rc.32"
SEQUENCE = 32
RELEASE_KEY_SHA256 = "26f0051185d9c1abada3b5adcd3d11c88f522e09b3850211a04773250c267ffb"
SOURCE_LOCK_SHA256 = "0b05a22938ea205cad342a018e2914c210afab6d67b05530bc0e3260f0f3b294"
COMMITS = {
    "stack": "e6619044501735f37096c661d9d6f176dc301f39",
...
PACKAGES = {
    "linux-amd64": {
        ...
        "sha256": "8eba5685085f837b4ca00f4c31ef5f7c246d06e05e1ff0068e36fe92738556ea",
        "size_bytes": 638975814,
    },
    "linux-arm64": {
        "filename": f"pool-stack-docker-{VERSION}-linux-arm64.zip",
        "sha256": "26a1c166b1dbbfa26323de75bf9981c61dddababfbefddbb935ba6e33e9cab4a",
        "size_bytes": 460286548,
    },
}
BOOTSTRAP = {
    "filename": "bootstrap.sh",
    "sha256": "05b13a320199f81b725051effaa4287c404b634647f19fd7b3146a4c38d71205",
    "size_bytes": 5213,
}
...
class Validator:
    ...
    def finish(self, mode: str) -> None:
        if self.errors:
            print(f"RC32 {mode} validation failed:")
            for error in self.errors:
                print(f"- {error}")
            raise SystemExit(1)
        print(f"RC32 {mode} validation passed ({self.checks} checks).")
...
def verify_release_lock(validator: Validator, lock: dict[str, Any]) -> None:
    ...
    if len(decoded) != 64:
        return
    with tempfile.TemporaryDirectory(prefix="rc32-lock-verify-") as temporary:
