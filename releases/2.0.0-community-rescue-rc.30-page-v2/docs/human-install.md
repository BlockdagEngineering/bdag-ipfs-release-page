...
community release candidate for mainnet chain ID `1404`. This is release-page
revision 2. It includes bounded startup retries for temporary RPC and
peer-readiness conditions. A canonical checkpoint or boundary mismatch,
state-root mismatch, or network mismatch still fails immediately.
...
apply firewall and access controls before exposing the HTTP API.
