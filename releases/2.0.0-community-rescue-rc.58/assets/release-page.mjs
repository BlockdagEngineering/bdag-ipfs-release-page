...
export const EXPECTED_RELEASE_IDENTITY = Object.freeze({
  ...
  releaseUrl: "https://github.com/BlockdagEngineering/stack/tree/2.0.0-community-rescue-rc.58",
  stackCommit: "7642805f2a6c3195707985a2ca8a997cddbe04c6",
...
function renderManifest(manifest) {
  ...
  document.getElementById("datasetStatus").textContent = active && datasetsAbsent ? "No RC58 dataset" : "Dataset state locked";
  ...
  notice.innerHTML = active
    ? "<strong>Coinbase accounting restored.</strong> Future accepted blocks retain the complete node-issued reward through pool accounting. Historical wrapped credits require separate reconciliation, and automated payouts stay disabled until liquid and staked protocol receipts fund the ledger."
...
function renderUnavailable() {
  ...
  document.getElementById("softwareStatusDetail").textContent = "No RC58 software identity was accepted";
  document.getElementById("datasetStatus").textContent = "Dataset unavailable";
  document.getElementById("datasetStatusDetail").textContent = "No RC58 dataset identity was accepted";
