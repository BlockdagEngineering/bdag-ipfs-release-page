...
4. Admit data only from an authenticated canonical donor or the signed RC64
...
7. Stage the exact RC64 pool without changing the ASIC owner's payout identity.
