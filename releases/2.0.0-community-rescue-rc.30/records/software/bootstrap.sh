...
case "$ARCH_NAME" in
  x86_64|amd64)
    ...
    EXPECTED_SHA256='6fe3f6c055e8312d1b7a4afa49f40f664bdca474e4a88b9d18357adbf030f4f3'
    ;;
  arm64|aarch64)
    PAYLOAD_TARGET='linux-arm64'
    EXPECTED_SHA256='8c7ae12ee38d97022dbeed4219690296398d5ef9fe8187b34e55b3cc2eb83e40'
    ;;
  *)
