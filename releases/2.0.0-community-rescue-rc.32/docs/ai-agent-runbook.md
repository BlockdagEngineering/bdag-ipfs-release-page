# AI Agent Runbook: BlockDAG Community Rescue RC32

Use this runbook to install or diagnose `2.0.0-community-rescue-rc.32` for a
...
- Stack revision: `e6619044501735f37096c661d9d6f176dc301f39`
...
RC32 waits only for temporary committed-EVM-head and peer-readiness states
...
- **Software only:** retain compatible healthy data and install RC32.
...
continue through a chain-history or trust refusal. Known RC32 upgrade behavior:
...
current compatible peers, dashboard RC32 identity, no repeated fatal recovery
