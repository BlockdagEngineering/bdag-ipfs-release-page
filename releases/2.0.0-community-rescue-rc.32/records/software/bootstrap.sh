...
case "$ARCH_NAME" in
  x86_64|amd64)
    ...
    EXPECTED_SHA256='8eba5685085f837b4ca00f4c31ef5f7c246d06e05e1ff0068e36fe92738556ea'
    ;;
  arm64|aarch64)
    PAYLOAD_TARGET='linux-arm64'
    EXPECTED_SHA256='26a1c166b1dbbfa26323de75bf9981c61dddababfbefddbb935ba6e33e9cab4a'
    ;;
  *)
