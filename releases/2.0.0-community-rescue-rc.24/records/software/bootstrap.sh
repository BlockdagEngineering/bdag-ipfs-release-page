...
case "$ARCH_NAME" in
  x86_64|amd64)
    ...
    EXPECTED_SHA256='98fd017437ee8e2285b34448d53919b6ce92e76e20c626ad316653af0d1bfaf7'
    ;;
  arm64|aarch64)
    PAYLOAD_TARGET='linux-arm64'
    EXPECTED_SHA256='74f6695d8954725907b75a0947c48385ae953f6f2973c08ed5e2e61c677fac7a'
    ;;
  *)
