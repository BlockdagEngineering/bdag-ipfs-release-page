...
case "$ARCH_NAME" in
  x86_64|amd64)
    ...
    EXPECTED_SHA256='a8b70ddce1c2a63b8391da42716f3110f895cefcd4ed2a793d8e02e37af3fe51'
    ;;
  arm64|aarch64)
    PAYLOAD_TARGET='linux-arm64'
    EXPECTED_SHA256='766c4a6342d645dd8772b35af0ad781512c848f8c10c97523c9fab45b9ff66fb'
    ;;
  *)
