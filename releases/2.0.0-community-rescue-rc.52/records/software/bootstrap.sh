...
case "$ARCH_NAME" in
  x86_64|amd64)
    ...
    EXPECTED_SHA256='e5868053ad02f8b3ee4251b482bf6a62b928c41e46633d77398e47988042c61d'
    ;;
  arm64|aarch64)
    PAYLOAD_TARGET='linux-arm64'
    EXPECTED_SHA256='77b9e4d4b93f850b37af38f734c9cae8f42d4f26fbdbeb61416ecfc79b6439e4'
    ;;
  *)
